sap.ui.require([
  ...
  var sViewName = "it.horsa.gualapack.macchina.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "it.horsa.gualapack.macchina"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title it.horsa.gualapack.macchina"
            });
        }
      }
